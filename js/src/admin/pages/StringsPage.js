    ...
    return [
      ...
      m('.FoF-Linguist-Filters', [
        ...
        Dropdown.component(
          ...
          ['_all_except_admin', ...vnode.attrs.frontends].map((frontend) =>
            Button.component(
              {
                className: 'Button',
              ...
              frontend === '_all_except_admin'
                ? app.translator.trans('fof-linguist.admin.filters.frontend-all-except-admin')
            ...
            Button.component(
              {
                ...
                onclick: () => {
                  ...
                  if (
                    confirm(
                      extractText(
                        app.translator.trans('fof-linguist.admin.buttons.delete-redundant-confirm', {
            ...
            Button.component(
              {
                ...
                onclick: () => {
                  ...
                  if (
                    confirm(
                      extractText(
                        app.translator.trans('fof-linguist.admin.buttons.delete-all-confirm', {
                          count: strings.length + '',
                        })
                      )
                    )
      ...
      m('.FoF-Linguist-Results', [
        ...
        this.results.length > keys.length
          ? Button.component(
              ...
              app.translator.trans('fof-linguist.admin.buttons.load-more')
            )
          : null,
      ]),
    ];
    ...
    this.results = app.store.all('fof-linguist-string-key').filter((key) => {
      ...
      if (this.filters.missingTranslationsInLocales.length) {
        ...
        const hasOriginalTranslation = booleanCheck(
          operation,
          this.filters.missingTranslationsInLocales.map((locale) => {
