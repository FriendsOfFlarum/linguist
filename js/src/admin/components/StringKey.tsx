      ...
      <div className="FoF-Linguist-Key">
        ...
        <div className="FoF-Linguist-Locales">
          {localesAsArray().map((locale) => (
            <StringLocale locale={locale} stringKey={stringKey} highlight={highlight} onchange={onchange} />
          ))}
          <StringLocale locale={null} stringKey={stringKey} highlight={highlight} onchange={onchange} />
        </div>
      </div>
    );
  }
